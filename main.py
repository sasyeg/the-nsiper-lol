# Made by:
#   Original code, updates, and owner: sussyegg
#   Proxy support, fork, better UI, and developer: ! sussyegg
...
print(Visual.textToColour(f"[COLOR_LIGHT_BLUE]UGC-Sniper made by: sussyegg \n"
                   f"[COLOR_LIGHT_BLUE]thanks for using
time.sleep(3)


class UGCSniper:  # OMG guys he stole this from jelod!!
    def __init__(self):
